...
class Weatherdesgin extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        data: {},
      ...
      return (
        <div className={"widget ".concat(...background)}>
          <form onSubmit={this.changeLocation}>
            <h2>Weather Detector</h2>
            <div className= {`${
             this.state.showMe == true ? "inline-input-error inline-input-errorbox" : "inline-input inline-input"
            } `}>
              ...
              />
                ...
                <p className="contenterror">
               {this.state.showMe == true ? (
              <span className="errorcontent">Please enter the vaild city </span>
            ) : null}
              </p>
          ...
          <div className="main-display">
            ...
            <div className="main-info">
              ...
              {this.state.showDeg == true ? ( <div className="temp-unit">°C</div> ):null}
            </div>
